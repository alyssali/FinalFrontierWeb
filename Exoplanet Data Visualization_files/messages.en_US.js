...
Globalize.b419230001 = messageFormatterFn((function(  ) {
  return function (d) { return "When Shown"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a1882025923 = messageFormatterFn((function(  ) {
  return function (d) { return "When Hidden"; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.b1953127488 = messageFormatterFn((function(  ) {
  return function (d) { return "Show template project contributors!"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a1732823365 = messageFormatterFn((function(  ) {
  return function (d) { return "Hide template project contributors!"; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.b1218526007 = messageFormatterFn((function(  ) {
...
Globalize.b1915849652 = messageFormatterFn((function(  ) {
  return function (d) { return "Click to expand"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a556149662 = messageFormatterFn((function(  ) {
  return function (d) { return "Click to collapse"; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a1460004584 = messageFormatterFn((function(  ) {
...
Globalize.a1087277240 = messageFormatterFn((function(  ) {
  return function (d) { return "Couldn't process field due to row-level security."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a51079122 = messageFormatterFn((function(  ) {
  return function (d) { return "Ask Data doesn't support this field at this time."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.b2001950641 = messageFormatterFn((function(  ) {
  return function (d) { return "Value indexing has been turned off by the data source owner."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a897333152 = messageFormatterFn((function(  ) {
  return function (d) { return "Ask Data will recognize field values only if you surround them with quotation marks."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b1104776001 = messageFormatterFn((function(  ) {
  return function (d) { return "Can’t analyze data due to a system error."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a2019274323 = messageFormatterFn((function(  ) {
  return function (d) { return "Can't load data."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b607519694 = messageFormatterFn((function(  ) {
  return function (d) { return "System error."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.b2033285784 = messageFormatterFn((function(  ) {
  return function (d) { return "For best results, ask the data source owner to remove them."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b1983802233 = messageFormatterFn((function(  ) {
  return function (d) { return "Can't process data source due to user filters."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a539528712 = messageFormatterFn((function(  ) {
  return function (d) { return "Description"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a1802475890 = messageFormatterFn((function(  ) {
  return function (d) { return "Formula"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a1168500503 = messageFormatterFn((function(  ) {
  return function (d) { return "Analyzing values..."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b201437342 = messageFormatterFn((function(  ) {
  return function (d) { return "Synonyms: "; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a805729772 = messageFormatterFn((function(  ) {
  return function (d) { return d.count + " values(" + d.countd + " unique)"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a2145565629 = messageFormatterFn((function(  ) {
  return function (d) { return "End"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b98700970 = messageFormatterFn((function(  ) {
  return function (d) { return "Start"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a305756939 = messageFormatterFn((function(  ) {
  return function (d) { return "Average"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a1010641320 = messageFormatterFn((function(  ) {
  return function (d) { return "Maximum"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a1667557370 = messageFormatterFn((function(  ) {
  return function (d) { return "Minimum"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b87532464 = messageFormatterFn((function(  ) {
  return function (d) { return "Most Common Values"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a2078805500 = messageFormatterFn((function(  ) {
...
Globalize.b1462304073 = messageFormatterFn((function(  ) {
...
Globalize.b753739119 = messageFormatterFn((function(  ) {
...
Globalize.a670085689 = messageFormatterFn((function(  ) {
...
Globalize.a401166476 = messageFormatterFn((function(  ) {
  return function (d) { return "CONVERSE: Ask a question about this data..."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a1057938591 = messageFormatterFn((function(  ) {
  return function (d) { return "Histograms require a \"count\" aggregation, so we changed \"" + d.originField + "\" to \"" + d.destField + "\""; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a1042618002 = messageFormatterFn((function(  ) {
  return function (d) { return "Histograms require a \"count\" aggregation, so we changed the viz type."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.b203909524 = messageFormatterFn((function(  ) {
  return function (d) { return "Select Viz Type"; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a332623435 = messageFormatterFn((function(  ) {
  return function (d) { return "Every value in the list must have a unique display name. Double-click in the \"Display As\" column to edit display names. Duplicates will automatically be removed when you click OK."; }
})(), Globalize("en").pluralGenerator({}));
